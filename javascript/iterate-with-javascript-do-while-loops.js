...
// the loop no matter what, and then continue to run the loop
...
// and the resulting array will look like [0, 1, 2, 3, 4]. However,
// what makes the do...while different from other loops is how it behaves
...
// When we execute the while loop, the condition evaluates to false
// because i is not less than 5, so we do not execute the code inside the loop.
...
// We will add a single element to the array and then increment i
// before we get to the condition check. When we finally evaluate the condition i < 5 on the last line,
