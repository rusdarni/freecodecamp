...
// In the base case, where n <= 0, it returns 1. For larger values of n,
// it calls itself, but with n - 1. That function call is evaluated in the same way,
// calling multiply again until n <= 0. At this point, all the functions can return
